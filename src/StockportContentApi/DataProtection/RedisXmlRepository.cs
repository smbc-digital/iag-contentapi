...
///         <see cref="Microsoft.AspNetCore.DataProtection.KeyManagement.KeyRingProvider" />
...
public class RedisXmlRepository : IXmlRepository, IDisposable
{
    ...
    public RedisXmlRepository(IConnectionMultiplexer connection, ILogger<RedisXmlRepository> logger)
    {
        ...
        string configuration = Regex.Replace(_connection.Configuration, @"password\s*=\s*[^,]*", "password=****",
