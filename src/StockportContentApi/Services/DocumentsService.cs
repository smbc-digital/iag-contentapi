...
{
    Task<Document> GetSecureDocumentByAssetId(string businessId, string assetId);
}
                            ...
                            IContentfulConfigBuilder contentfulConfigBuilder) : IDocumentService
{
    ...
    public async Task<Document> GetSecureDocumentByAssetId(string businessId, string assetId)
    {
