...
namespace StockportContentApiTests.Unit.ContentfulFactories
{
    public class ArticleContentfulFactoryTest
    {
        ...
        public void ShouldCreateAnArticleFromAContentfulArticle()
        {
            ...
            sectionFactory.Setup(o => o.ToModel(contentfulArticle.Sections.First().Fields)).Returns(section);
            ...
            profileFactory.Setup(o => o.ToModel(contentfulArticle.Profiles.First().Fields)).Returns(profile);
            ...
            topicFactory.Setup(o => o.ToModel(contentfulArticle.ParentTopic.Fields)).Returns(topic);
            ...
            article.Alerts.First().ShouldBeEquivalentTo(contentfulArticle.Alerts.First().Fields);
            article.LiveChat.ShouldBeEquivalentTo(contentfulArticle.LiveChat.Fields);
            ...
            sectionFactory.Verify(o => o.ToModel(contentfulArticle.Sections.First().Fields), Times.Once);
            ...
            profileFactory.Verify(o => o.ToModel(contentfulArticle.Profiles.First().Fields), Times.Once);
            article.Profiles.First().ShouldBeEquivalentTo(profile);

            topicFactory.Verify(o => o.ToModel(contentfulArticle.ParentTopic.Fields), Times.Once);
