...
public class FooterContentfulFactoryTest
{
    ...
    public void ShouldCreateAFooterFromAContentfulReference()
    {
        ...
        factory.Setup(_subItemFactory => _subItemFactory.ToModel(It.IsAny<ContentfulReference>()))
            .Returns(new SubItem("slug", "title", "teaser", "icon", "type", "contentType", DateTime.MinValue, DateTime.MaxValue, "image", 222, "body text", new List<SubItem>(), "externalLink", "button text", EColourScheme.Orange, string.Empty, string.Empty));
