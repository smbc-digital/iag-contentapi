...
public class ShowcaseContentfulFactoryTest
{
    ...
    public void ShouldCreateAShowcaseFromAContentfulShowcase()
    {
        List<SubItem> subItems = new() {
            new("slug", "title", "teaser", "icon", "type", "contentType", DateTime.MinValue, DateTime.MaxValue, "image", 123, "body text", new List<SubItem>(), "externalLink", "button text", EColourScheme.Blue) };
        ...
        topicFactory.Setup(o => o.ToModel(It.IsAny<ContentfulReference>())).Returns(new SubItem("slug", "title", "teaser", "icon", "type", "contenType", DateTime.MinValue, DateTime.MaxValue, "image", 123, "body text", new List<SubItem>(), "externalLink", "button text", EColourScheme.Blue));
    ...
    public void ShouldCreateAShowcaseWithAnEmptyFeaturedItems()
    {
        ...
        topicFactory.Setup(o => o.ToModel(It.IsAny<ContentfulReference>()))
            .Returns(new SubItem("slug", "title", "teaser", "icon", "type", "contentType", DateTime.MinValue, DateTime.MaxValue, "image", 234, "body text", new List<SubItem>(), "externalLink", "button text", EColourScheme.Blue));
    ...
    public void ShouldCreateAShowcaseWithoutExpiredSubItems()
    {
        ...
        Mock<IContentfulFactory<ContentfulReference, SubItem>> topicFactory = new();
        topicFactory.Setup(o => o.ToModel(It.IsAny<ContentfulReference>()))
            .Returns(new SubItem("slug", "title", "teaser", "icon", "type", "contentType", DateTime.MinValue, DateTime.MaxValue, "image", 456, "body text", new List<SubItem>(), "externalLink", "button text", EColourScheme.Blue));
    ...
    public void ShouldCreateAShowcaseWithoutSubItemsThatHaveNotArisen()
    {
        ...
        Mock<IContentfulFactory<ContentfulReference, SubItem>> topicFactory = new();
        topicFactory.Setup(o => o.ToModel(It.IsAny<ContentfulReference>()))
            .Returns(new SubItem("slug", "title", "teaser", "icon", "type", "contentType", DateTime.MinValue, DateTime.MaxValue, "image", 789, "body text", new List<SubItem>(), "externalLink", "button text", EColourScheme.Blue));
