...
public class ShowcaseContentfulFactoryTest
{
   ...
   public void ShouldCreateAShowcaseFromAContentfulShowcase()
   {
       var subItems = new List<SubItem> {
           new SubItem("slug", "title", "teaser", "icon", "type", "contentType", DateTime.MinValue, DateTime.MaxValue, "image", new List<SubItem>()) };
       ...
       topicFactory.Setup(o => o.ToModel(It.IsAny<ContentfulReference>())).Returns(new SubItem("slug", "title", "teaser", "icon", "type", "contentType", DateTime.MinValue, DateTime.MaxValue, "image", new List<SubItem>()));
   ...
   public void ShouldCreateAShowcaseWithAnEmptyFeaturedItems()
   {
       ...
       topicFactory.Setup(o => o.ToModel(It.IsAny<ContentfulReference>()))
           .Returns(new SubItem("slug", "title", "teaser", "icon", "type", "content-type", DateTime.MinValue, DateTime.MaxValue, "image", new List<SubItem>()));
