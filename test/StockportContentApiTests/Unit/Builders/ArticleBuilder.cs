...
namespace StockportContentApiTests.Unit.Builders
{
    public class ArticleBuilder
    {
        ...
        private Topic _parentTopic = new Topic("slug", "name", "teaser", "summary", "icon", "background", new List<SubItem>(), new List<SubItem>(), new List<SubItem>(), new List<Crumb>(), 
        ...
        {
            return new Article(_body, _slug, _title, _teaser, _icon, _backgroundImage, _sections, 
