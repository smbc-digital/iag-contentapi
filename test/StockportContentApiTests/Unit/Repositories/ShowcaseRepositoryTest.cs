...
public class ShowcaseRepositoryTest
{
   ...
   public ShowcaseRepositoryTest()
   {
       ...
       _repository = new ShowcaseRepository(config, contentfulFactory, contentfulClientManager.Object, newsListFactory.Object, _topicFactory.Object, eventRepository, _mockLogger.Object);
   }

   [Fact(Skip = "Needs to be fixed as part of the showcase redesign")]
