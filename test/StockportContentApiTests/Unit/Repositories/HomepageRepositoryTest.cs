...
public class HomepageRepositoryTest
{
    ...
    public void ItGetsHomepage()
    {
        ...
        _homepageFactory.Setup(o => o.ToModel(It.IsAny<ContentfulHomepage>()))
            .Returns(new Homepage(new List<string>(), string.Empty, string.Empty, new List<SubItem>(), new List<SubItem>(), new List<Alert>(), new List<CarouselContent>(), string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, null, string.Empty, string.Empty, new CarouselContent(), new CallToActionBanner(), null));
