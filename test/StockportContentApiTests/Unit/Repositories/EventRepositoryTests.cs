...
public class EventRepositoryTests
{
    ...
    public EventRepositoryTests()
    {
        ...
        _alertFactory.Setup(o => o.ToModel(It.IsAny<ContentfulAlert>())).Returns(new Alert("title", "subHeading",
            "body",
            "severity", new(0001, 1, 1, 0, 0, 0, DateTimeKind.Utc),
            new(9999, 9, 9, 0, 0, 0, DateTimeKind.Utc), string.Empty, false, string.Empty));
        ...
        _eventCategoryFactory.Setup(o => o.ToModel(It.IsAny<ContentfulEventCategory>()))
            .Returns(new EventCategory(string.Empty, string.Empty, string.Empty));
    ...
    public void GetReoccuringEventsNextEventOnly()
    {
        ...
        ContentfulEvent rawEvent = new ContentfulEventBuilder().EventCategory(new() { "category" })
            .EventDate(new(2017, 06, 01)).Occurrences(10).Frequency(EventFrequency.Weekly).Build();
        ...
        result[0].EventDate.Should().Be(new(2017, 07, 06));
    }
    ...
    public void GetsParticularReccuringEventFromASlug()
    {
        ...
        ContentfulEvent anEvent =
            new ContentfulEventBuilder().EventDate(new(2017, 04, 01)).Slug(slug)
                .Frequency(frequency)
                .Occurrences(occurences)
                .Build();
        ContentfulEvent anotherEvent = new ContentfulEventBuilder().Slug("slug-2").Featured(false)
            .EventDate(new(2017, 09, 01)).Build();
        ContentfulEvent aThirdEvent = new ContentfulEventBuilder().Slug("slug-3").Featured(false)
        ...
        _contentfulClient.Setup(o =>
                o.GetEntries(It.Is<QueryBuilder<ContentfulEvent>>(q => q.Build().Equals(builder.Build())),
        ...
        eventItem.EventDate.Should().Be(new(2017, 04, 02));
    }
    ...
    public void GetsA404ForANotFoundEventItem()
    {
        ...
        HttpResponse response =
            AsyncTestHelper.Resolve(_repository.GetEvent("event-not-found", new DateTime(2017, 4, 1)));
    ...
    public void ShouldGetEventsIfContainingGroupIsNotArchived()
    {
        ...
        ContentfulEvent anEvent = new ContentfulEventBuilder().EventDate(new(2016, 09, 08)).Build();
        ContentfulEvent anotherEvent = new ContentfulEventBuilder().EventDate(new(2016, 10, 08)).Build();
        ContentfulEvent archivedvents = new ContentfulEventBuilder().EventDate(new(2016, 10, 08)).Build();
        ...
        QueryBuilder<CancellationToken> builder = new QueryBuilder<CancellationToken>().ContentTypeIs("events")
            .Include(2).Limit(ContentfulQueryValues.LIMIT_MAX);
    ...
    public void ShouldGet404IfContentNotFound()
    {
        ...
        _contentfulClient.Setup(o => o.GetEntries(It.IsAny<QueryBuilder<Event>>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(new ContentfulCollection<Event>());
    ...
    public void ShouldGetAllEventsWithTheirDailyReccuringParts()
    {
        ...
        ContentfulEvent anEvent =
            new ContentfulEventBuilder().EventDate(new(2017, 04, 01))
                .Frequency(frequency)
                .Occurrences(occurences)
                .Build();
        ...
        eventCalender.Events[1].EventDate.Should().Be(new(2017, 04, 02));
        eventCalender.Events[2].EventDate.Should().Be(new(2017, 04, 03));
    }
    ...
    public void ShouldGetAllEventsWithTheirWeeklyReccuringParts()
    {
        ...
        eventCalender.Events.Count.Should().Be(occurences);
        eventCalender.Events[0].EventDate.Should().Be(new(2017, 04, 01));
        eventCalender.Events[1].EventDate.Should().Be(new(2017, 04, 08));
        eventCalender.Events[2].EventDate.Should().Be(new(2017, 04, 15));
        eventCalender.Events[3].EventDate.Should().Be(new(2017, 04, 22));
    }
    ...
    public void ShouldGetWeeklyRepeatedDatesBetweenDates()
    {
        ...
        HttpResponse response =
            AsyncTestHelper.Resolve(_repository.Get(new DateTime(2017, 04, 01), new DateTime(2017, 04, 16), null, 0,
                null, null, null, 0, 0));
    ...
    public void ShouldGetAllEventsWithTheirForthnightlyReccuringParts()
    {
        ...
        eventCalender.Events.Count.Should().Be(occurences);
        eventCalender.Events[0].EventDate.Should().Be(new(2017, 04, 01));
        eventCalender.Events[1].EventDate.Should().Be(new(2017, 04, 15));
        eventCalender.Events[2].EventDate.Should().Be(new(2017, 04, 29));
    }
    ...
    public void ShouldGetAllEventsWithTheirMonthlyReccuringParts()
    {
        ...
        eventCalender.Events.Count.Should().Be(occurences);
        eventCalender.Events[0].EventDate.Should().Be(new(2017, 04, 01));
        eventCalender.Events[1].EventDate.Should().Be(new(2017, 05, 01));
        eventCalender.Events[2].EventDate.Should().Be(new(2017, 06, 01));
        eventCalender.Events[3].EventDate.Should().Be(new(2017, 07, 01));
    }
    ...
    public void ShouldGetAllEventsWithTheirYearlyReccuringParts()
    {
        ...
        eventCalender.Events.Count.Should().Be(occurences);
        eventCalender.Events[0].EventDate.Should().Be(new(2017, 04, 01));
        eventCalender.Events[1].EventDate.Should().Be(new(2018, 04, 01));
        eventCalender.Events[2].EventDate.Should().Be(new(2019, 04, 01));
    }
    ...
    public void ShouldGetEventsWithinDateRange()
    {
        ...
        ContentfulEvent anEvent = new ContentfulEventBuilder().EventDate(new(2016, 09, 01)).Build();
        ...
        // Act
        HttpResponse response =
            AsyncTestHelper.Resolve(_repository.Get(dateFrom, dateTo, null, 0, null, null, null, 0, 0));
    ...
    public void ShouldGetOneEventForACategory()
    {
        ...
        ContentfulEvent anEvent =
            new ContentfulEventBuilder().EventCategoryList(new() { contentfulCategory1, contentfulCategory2 }).Build();
        ContentfulEvent anotherEvent = new ContentfulEventBuilder()
            .EventCategoryList(new() { new() { Name = "Category 2", Slug = "category-2" } }).Build();
        List<ContentfulEvent> events = new() { anEvent, anotherEvent };
        ...
        // Act
        HttpResponse response =
            AsyncTestHelper.Resolve(_repository.Get(null, null, "category 1", 0, null, null, null, 0, 0));
    ...
    public void ShouldGetTwoEventsForACategory()
    {
        ...
        // Act
        HttpResponse response =
            AsyncTestHelper.Resolve(_repository.Get(null, null, "category 2", 0, null, null, null, 0, 0));
    ...
    public void ShouldGetEventForACategoryAndDate()
    {
        ...
        ContentfulEvent event1 =
            new ContentfulEventBuilder().EventCategoryList(new() { contentfulCategory1 })
                .EventDate(new(2017, 08, 01))
                .Build();
        ContentfulEvent event2 =
            new ContentfulEventBuilder().EventCategoryList(new() { contentfulCategory2 })
                .EventDate(new(2016, 08, 01))
                .Build();
        ContentfulEvent event3 =
            new ContentfulEventBuilder().EventCategoryList(new() { contentfulCategory3 })
                .EventDate(new(2016, 08, 01))
                .Build();

        List<ContentfulEvent> events = new() { event1, event2, event3 };

        _eventCategoryFactory.Setup(o => o.ToModel(contentfulCategory1))
            .Returns(new EventCategory("Category 1", "category-1", "icon1"));
        _eventCategoryFactory.Setup(o => o.ToModel(contentfulCategory2))
            .Returns(new EventCategory("Category 2", "category-2", "icon2"));
        ...
        // Act
        HttpResponse response =
            AsyncTestHelper.Resolve(_repository.Get(dateFrom, dateTo, "Category 3", 0, null, null, null, 0, 0));
    ...
    {
        ContentfulEvent anEvent = new ContentfulEventBuilder().Featured(true).EventDate(new(2017, 09, 01)).Build();
        ContentfulEvent anotherEvent = new ContentfulEventBuilder().Featured(true).EventDate(new(2017, 10, 10)).Build();
    ...
    {
        ContentfulEvent anEvent = new ContentfulEventBuilder().Featured(false).EventDate(new(2017, 09, 01)).Build();
        ContentfulEvent anotherEvent =
            new ContentfulEventBuilder().Featured(false).EventDate(new(2017, 10, 10)).Build();
        ContentfulEvent aThirdEvent = new ContentfulEventBuilder().Featured(true).EventDate(new(2017, 09, 15)).Build();
        List<ContentfulEvent> events = new() { anEvent, anotherEvent, aThirdEvent };
    ...
    {
        ContentfulEvent anEvent = new ContentfulEventBuilder().Slug("slug-1").Featured(false)
            .EventDate(new(2017, 09, 01)).Build();
        ContentfulEvent anotherEvent = new ContentfulEventBuilder().Slug("slug-2").Featured(false)
            .EventDate(new(2017, 09, 01)).Build();
        ContentfulEvent aThirdEvent = new ContentfulEventBuilder().Slug("slug-3").Featured(false)
    ...
    public void ShouldReturnNoEventsIfTheGroupIsReferencedByNone()
    {
        ...
        _groupFactory.Setup(g => g.ToModel(It.Is<ContentfulGroup>(o => !o.Slug.Equals("zumba-fitness"))))
            .Returns(othergroup);
    ...
    {
        // Arrange
        List<ContentfulEvent> events = new()
        {
            new ContentfulEventBuilder().Build(), new ContentfulEventBuilder().Build(),
    ...
    {
        //Arrange 
        ContentfulEvent firstEvent = new ContentfulEventBuilder().Featured(false).EventDate(new(2017, 09, 01)).Build();
        ContentfulEvent secondEvent = new ContentfulEventBuilder().Featured(false).EventDate(new(2017, 09, 02))
            .StartTime("8:00").Build();
        ContentfulEvent thirdEvent = new ContentfulEventBuilder().Featured(false).EventDate(new(2017, 09, 02))
            .StartTime("8:30").Build();
