    ...
    public class GroupRepositoryTest
    {
        ...
        public void GetsGroupForGroupSlug()
        {
            ...
            var group = new Group("name", "group_slug", "phoneNumber", "email",
                "website", "twitter", "facebook", "address", "description", "imageUrl", "thumbnailImageUrl", null, null, null, false, null, DateTime.MinValue, DateTime.MaxValue, "published", string.Empty, string.Empty, string.Empty);
        ...
        public void GetsGroupWhenHiddenDatesAreInThePast()
        {
            ...
            var group = new Group("name", "group_slug", "phoneNumber", "email",
                "website", "twitter", "facebook", "address", "description", "imageUrl", "thumbnailImageUrl", null, null, null, false, null, DateTime.Now.AddDays(-3), DateTime.Now.AddDays(-1), "published", string.Empty, string.Empty, string.Empty);
            var builder = new QueryBuilder<ContentfulGroup>().ContentTypeIs("group").FieldEquals("fields.slug", slug).Include(1);
        ...
        public void GetsGroupWhenHiddenDatesAreInTheFuture()
        {
            ...
            var group = new Group("name", "group_slug", "phoneNumber", "email",
                "website", "twitter", "facebook", "address", "description", "imageUrl", "thumbnailImageUrl", null, null, null, false, null, DateTime.Now.AddDays(1), DateTime.Now.AddDays(3), "published", string.Empty, string.Empty, string.Empty);
            var builder = new QueryBuilder<ContentfulGroup>().ContentTypeIs("group").FieldEquals("fields.slug", slug).Include(1);
        ...
        public void DoesntGetGroupWhenHiddenDatesAreNow()
        {
            ...
            var group = new Group("name", "group_slug", "phoneNumber", "email",
                "website", "twitter", "facebook", "address", "description", "imageUrl", "thumbnailImageUrl", null, null, null, false, null, DateTime.Now.AddDays(-3), DateTime.Now.AddDays(3), "published", string.Empty, string.Empty, string.Empty);
            var builder = new QueryBuilder<ContentfulGroup>().ContentTypeIs("group").FieldEquals("fields.slug", slug).Include(1);
        ...
        public void DoesntGetGroupWhenHiddenDateFromIsInThePastAndHiddenDateToIsNull()
        {
            ...
            var group = new Group("name", "group_slug", "phoneNumber", "email",
                "website", "twitter", "facebook", "address", "description", "imageUrl", "thumbnailImageUrl", null, null, null, false, null, DateTime.Now.AddDays(-3), null, "published", string.Empty, string.Empty, string.Empty);
            var builder = new QueryBuilder<ContentfulGroup>().ContentTypeIs("group").FieldEquals("fields.slug", slug).Include(1);
        ...
        public void DoesntGetGroupWhenHiddenDateToIsInTheFutureAndHiddenDateFromIsNull()
        {
            ...
            var group = new Group("name", "group_slug", "phoneNumber", "email",
                "website", "twitter", "facebook", "address", "description", "imageUrl", "thumbnailImageUrl", null, null, null, false, null, null, DateTime.Now.AddDays(3), "published", string.Empty, string.Empty, string.Empty);
            var builder = new QueryBuilder<ContentfulGroup>().ContentTypeIs("group").FieldEquals("fields.slug", slug).Include(1);
        ...
        public void ShouldReturnALocationWhenSelected()
        {
            ...
            var groupWithLocation = new Group("name", slug, "phoneNumber", "email",
                "website", "twitter", "facebook", "address", "description", "imageUrl", "thumbnailImageUrl", null, null, location, false, null, DateTime.MinValue, DateTime.MaxValue, "published", string.Empty, string.Empty, string.Empty);
        ...
        public void ShouldReturnVolunteeringWhenSelected()
        {
            ...
            var groupWithLocation = new Group("name", slug, "phoneNumber", "email",
                "website", "twitter", "facebook", "address", "description", "imageUrl", "thumbnailImageUrl", null, null, location, volunteering, null, DateTime.MinValue, DateTime.MaxValue, "published", string.Empty, string.Empty, string.Empty);
